					...
					<Content graphic="/images/services/studio.jpg" isReversed={false}>
						...
						<div className="text-neutral-400">
							...
							<p className="py-2">
								...
								the stage is built for seamless live-action + virtual integration. Whether you need
								a single-camera hero shot or a full 270° immersive set, this is the Midwest’s most
								capable virtual production destination.
							</p>
						</div>
					</Content>
				</ContentWrapper>
				...
				<ContentWrapper variant="wide">
					<Content graphic="/images/content-1-1.png" isReversed={true}>
						...
						<div className="text-neutral-400">
							...
							<p className="py-2">
								Hands-on demo nights, private workshops, and quick-reference guides cover everything
								from basic LED workflows to advanced nDisplay and camera tracking. Whether you’re
								new to virtual production or a seasoned DP, these sessions turn “first time on a
								volume” into “nailed it on take one.”
							</p>
						</div>
					</Content>
				</ContentWrapper>
				...
				<ContentWrapper variant="wide">
					<Content graphic="/images/services/post.png" isReversed={true}>
						...
						<div className="text-neutral-400">
							...
							<p className="py-2">
								Direct access to the original Unreal assets and on-set data means perfect continuity
								and faster turnarounds — from quick commercial deliverables to full narrative
								finishing.
							</p>
						</div>
					</Content>
